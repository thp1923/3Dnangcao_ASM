    ...
    class BacklinkStore {
        ...
        public void Init() {
            ...
            var paths = AssetDatabase.GetAllAssetPaths()
                .Distinct()
                .Where(s => s.StartsWith("Assets", StringComparison.OrdinalIgnoreCase) || s.StartsWith("ProjectSettings", StringComparison.OrdinalIgnoreCase) || s.StartsWith ("Packages", StringComparison.OrdinalIgnoreCase))
                .Where(p => {
